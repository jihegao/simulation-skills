...
| `biped_microgravity` | Physics-style static check | `python3 examples/biped_microgravity/run_experiment.py` | `python3 examples/biped_microgravity/static_viewer.py` | Quasi-static standing criterion, not full multibody dynamics. |
